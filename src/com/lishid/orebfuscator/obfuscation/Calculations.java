...
public class Calculations
{
    ...
    {
        if (OrebfuscatorConfig.getDarknessHideBlocks() && OrebfuscatorConfig.isDarknessObfuscated(id))
        {
            return true;
        }
        if (OrebfuscatorConfig.getUseProximityHider() && OrebfuscatorConfig.isProximityObfuscated(id))
        {
            return true;
        }
        return false;
