...
public class ConfigDefault extends ConfigDefaults {
	...
	public ConfigDefault() {
		...
		// Default World
		this.defaultProximityHiderBlockIds = convertMaterialsToIds(
		...
		this.defaultDarknessBlockIds = convertMaterialsToIds(
		...
		this.endWorldObfuscateBlockIds = convertMaterialsToIds(new Material[] { Material.END_STONE });

		this.endWorldMode1BlockId = getMaterialIds(Material.END_STONE).iterator().next();
		this.endWorldRequiredObfuscateBlockIds = convertMaterialsToIds(new Material[] { Material.END_STONE });

		// Nether World
		this.netherWorldRandomBlockIds = convertMaterialsToIds(new Material[] { Material.GRAVEL, Material.NETHERRACK,
				Material.SOUL_SAND, Material.NETHER_BRICKS, Material.NETHER_QUARTZ_ORE });
		...
		this.normalWorldRandomBlockIds = convertMaterialsToIds(new Material[] { Material.STONE, Material.COBBLESTONE,
				Material.OAK_PLANKS, Material.GOLD_ORE, Material.IRON_ORE, Material.COAL_ORE, Material.LAPIS_ORE,
		...
		this.normalWorldObfuscateBlockIds = convertMaterialsToIds(new Material[] { Material.GOLD_ORE, Material.IRON_ORE,
				Material.COAL_ORE, Material.LAPIS_ORE, Material.CHEST, Material.TRAPPED_CHEST, Material.ENDER_CHEST,
				Material.DIAMOND_ORE, Material.ENDER_CHEST, Material.REDSTONE_ORE, Material.CLAY, Material.EMERALD_ORE,
