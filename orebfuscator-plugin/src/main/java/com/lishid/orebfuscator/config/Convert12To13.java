...
public class Convert12To13 {
	...
	private void setGlobalValues() {
		...
		this.config.set("Strings.NoObfuscationForMetadataTagName",
				oldConfig.get("Strings.NoObfuscationForMetadataTagName"));
	...
	private void setWorldValues() {
		...
		this.config.set("Worlds.Default.AntiTexturePackAndFreecam",
				oldConfig.get("Booleans.AntiTexturePackAndFreecam"));
		...
		this.config.set("Worlds.Default.ProximityHider.UseSpecialBlock",
				oldConfig.get("Booleans.UseSpecialBlockForProximityHider"));
		this.config.set("Worlds.Default.ProximityHider.ObfuscateAboveY",
				oldConfig.get("Booleans.UseYLocationProximity"));
		this.config.set("Worlds.Default.ProximityHider.ProximityHiderBlocks",
				oldConfig.get("Lists.ProximityHiderBlocks"));
